...
{% include image.html class="large-width" file="11011110.grid.png" caption="" %}
...
{% include image.html class="large-width" file="rc5.png" caption="" %}
...
{% include image.html class="large-width" file="11011110.nogrid.png" caption="" %}
