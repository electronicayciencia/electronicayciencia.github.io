...
{% include image.html class="original-width" file="alim_dual.png" caption="" %}
...
{% include image.html class="original-width" file="masa_virtual.png" caption="" %}
...
{% include image.html class="small-width" file="masa_virtual_b.png" caption="" %}
...
{% include image.html class="large-width" file="ac_coupling.png" caption="" %}
...
{% include image.html class="small-width" file="inversor_crudo.png" caption="" %}
...
{% include image.html class="original-width" file="buffer.png" caption="" %}
...
{% include image.html class="medium-width" file="inversor_parabode.png" caption="" %}
...
{% include image.html class="large-width" file="bode1.png" caption="" %}
...
{% include image.html class="large-width" file="inversor_ejemplo.png" caption="" %}
