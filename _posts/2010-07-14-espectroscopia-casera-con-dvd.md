...
{% include image.html class="small-width" file="Imagen065_2.jpg" caption="" %}
...
{% include image.html class="original-width" file="angulo.png" caption="" %}
...
{% include image.html class="large-width" file="Fluorescente.jpg_esp_150_1.png" caption="" %}
...
{% include image.html class="large-width" file="Imagen188.jpg_esp.png" caption="" %}
...
{% include image.html class="small-width" file="Imagen188.jpg" caption="" %}
...
{% include image.html class="original-width" file="dobletes.png" caption="" %}
...
{% include image.html class="large-width" file="Imagen057.jpg_esp_400_1.png" caption="" %}
...
{% include image.html class="large-width" file="Imagen172.jpg_esp_400_1.png" caption="" %}
