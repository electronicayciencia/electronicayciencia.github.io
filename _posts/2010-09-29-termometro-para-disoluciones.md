...
{% include image.html class="original-width" file="termoboli.png" caption="" %}
...
{% include image.html class="original-width" file="BENQ0032.JPG" caption="" %}
...
{% include image.html class="original-width" file="BENQ0025.JPG" caption="" %}
