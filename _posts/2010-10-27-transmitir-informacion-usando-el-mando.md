...
{% include image.html class="medium-width" file="Imagen256.jpg" caption="" %}
...
{% include image.html class="small-width" file="transiciones.png" caption="" %}
...
{% include image.html class="medium-width" file="hist_BA.png" caption="" %}
...
{% include image.html class="medium-width" file="hist_AC.png" caption="" %}
...
{% include image.html class="large-width" file="hist_AB.png" caption="" %}
...
{% include image.html class="medium-width" file="Imagen005.jpg" caption="" %}
...
{% include image.html class="large-width" file="0F5555.png" caption="" %}
...
{% include image.html class="large-width" file="rx_debug.png" caption="" %}
