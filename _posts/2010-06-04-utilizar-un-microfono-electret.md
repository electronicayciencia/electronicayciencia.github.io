...
{% include image.html class="original-width" file="conn_electret.png" caption="" %}
...
{% include image.html class="original-width" file="BENQ0005.JPG" caption="" %}
...
{% include image.html class="original-width" file="p58-f4a.gif" caption="" %}
