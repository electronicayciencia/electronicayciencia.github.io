...
{% include image.html class="original-width" file="XOR_TABLE.jpg" caption="" %}
...
{% include image.html class="original-width" file="XOR_TABLE_cuadros.jpg" caption="" %}
...
{% include image.html class="large-width" file="xor.png" caption="" %}
