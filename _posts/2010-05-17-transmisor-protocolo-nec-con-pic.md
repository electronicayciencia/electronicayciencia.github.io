...
{% include image.html class="large-width" file="trace.png" caption="" %}
...
{% include image.html class="large-width" file="trace_zoom.png" caption="" %}
...
{% include image.html class="small-width" file="conexionado.png" caption="" %}
